...
async function testConsultarLoteRps() {
  ...
  const res = await new Promise(resolve => {
    const req = https.request('https://nfse.sefaz.salvador.ba.gov.br/ConsultaLoteRPS/ConsultaLoteRPS.svc', {
      method: 'POST',
      agent,
      headers: {
